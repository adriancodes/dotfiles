...
description: "Use when reviewing a router or switch configuration before deployment."
license: MIT
metadata:
  origin: ECC
  source: https://github.com/affaan-m/ECC/blob/e04ea0b9cc8248686edf5ac751cadff550e162b8/skills/network-config-validation/SKILL.md
  revision: e04ea0b9cc8248686edf5ac751cadff550e162b8
  category: Infrastructure and Data
  summary: "ECC reference for network config validation; adapted for explicit local scope and evidence-backed use."
---

# Network Config Validation — ECC Import
