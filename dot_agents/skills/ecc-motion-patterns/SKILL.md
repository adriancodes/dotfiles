...
description: "Use when animating React buttons, dialogs, toasts, lists, route changes, scroll reveals, or layout transitions."
license: MIT
metadata:
  origin: ECC
  source: "https://github.com/affaan-m/ECC/blob/e04ea0b9cc8248686edf5ac751cadff550e162b8/skills/motion-patterns/SKILL.md"
  revision: e04ea0b9cc8248686edf5ac751cadff550e162b8
  category: Web
  summary: "Motion recipes for common React UI transitions with bundled tokens and foundations."
---
> Attributed third-party import from [ECC](https://github.com/affaan-m/ECC/blob/e04ea0b9cc8248686edf5ac751cadff550e162b8/skills/motion-patterns/SKILL.md) at `e04ea0b9cc8248686edf5ac751cadff550e162b8`. Adapted for on-demand, harness-neutral use; not behaviorally evaluated or certified by this collection. See `LICENSE`.
...
Every pattern here is built on [bundled motion foundations](references/motion-foundations.md) tokens and springs.
...
- Every pattern imports from [bundled motion foundations](references/motion-foundations.md). No raw numbers.
...
8. **All token values are imported from [bundled motion foundations](references/motion-foundations.md).** No inline numbers.
...
the accessibility hook from [bundled motion foundations](references/motion-foundations.md):
...
- `ecc-motion-advanced` if available; otherwise use the patterns and bundled foundation here without installing or invoking another skill.
