...
description: "Use when reading, writing, or reviewing Cisco IOS / IOS-XE configuration or planning a change window."
license: MIT
metadata:
  origin: ECC
  source: https://github.com/affaan-m/ECC/blob/e04ea0b9cc8248686edf5ac751cadff550e162b8/skills/cisco-ios-patterns/SKILL.md
  revision: e04ea0b9cc8248686edf5ac751cadff550e162b8
  category: Infrastructure and Data
  summary: "ECC reference for cisco ios patterns; adapted for explicit local scope and evidence-backed use."
---

# Cisco Ios Patterns — ECC Import
...
- Optional workflow reference: `ecc-network-config-reviewer` (optional skill; if unavailable, review the exact proposed configuration and report evidence-backed lockout and forwarding risks)
