...
description: "Use when writing or reviewing Python typing, decorators, generators, context managers, packaging, or concurrency patterns."
license: MIT
metadata:
  origin: ECC
  source: https://github.com/affaan-m/ECC/blob/e04ea0b9cc8248686edf5ac751cadff550e162b8/skills/python-patterns/SKILL.md
  revision: e04ea0b9cc8248686edf5ac751cadff550e162b8
  category: Python
  summary: "Adapted ECC reference for python patterns; project contracts and caller authorization take precedence."
---
...
def fetch_all_urls(urls: list[str]) -> dict[str, str]:
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=10) as executor:
        ...
        for future in concurrent.futures.as_completed(future_to_url):
            ...
            results[url] = future.result()  # Preserve failed fetches as exceptions
    return results
```
