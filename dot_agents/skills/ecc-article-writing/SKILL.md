...
metadata:
  origin: ECC
  source: https://github.com/affaan-m/ECC/blob/e04ea0b9cc8248686edf5ac751cadff550e162b8/skills/article-writing/SKILL.md
...
Use supplied notes, references, and brand guidance or already-authorized source-reading tools. Report missing evidence instead of inventing claims. Drafting does not authorize publishing, account connections, or creating a durable voice record; save an artifact only where the task requests it.
...
If the user wants a specific voice, optionally use `ecc-brand-voice` and reuse its `VOICE PROFILE`; without it, extract rhythm, compression, claim style, preferred moves, and avoided moves from supplied examples into a short profile.
...
Adapted from ECC by Affaan Mustafa, revision `e04ea0b9cc8248686edf5ac751cadff550e162b8`. MIT license; see `LICENSE` in this directory. Local adaptations namespace the optional voice reference and clarify source prerequisites; no effectiveness or live-integration claim is made.
