...
description: "Use when implementing FastAPI routes, Pydantic schemas, async SQLAlchemy sessions, dependencies, authentication, or lifespan handling."
license: MIT
metadata:
  origin: ECC
  source: https://github.com/affaan-m/ECC/blob/e04ea0b9cc8248686edf5ac751cadff550e162b8/skills/fastapi-patterns/SKILL.md
  revision: e04ea0b9cc8248686edf5ac751cadff550e162b8
  category: Python
  summary: "Adapted ECC reference for fastapi patterns; project contracts and caller authorization take precedence."
---
...
async def lifespan(app: FastAPI):
    # Schema changes belong to a separately authorized migration workflow.
    try:
        yield
    finally:
