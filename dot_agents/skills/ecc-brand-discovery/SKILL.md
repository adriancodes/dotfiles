...
metadata:
  origin: ECC
  source: https://github.com/affaan-m/ECC/blob/e04ea0b9cc8248686edf5ac751cadff550e162b8/skills/brand-discovery/SKILL.md
...
Installation copies this guide and blank reference templates only; it does not begin an interview or create brand state. At invocation, confirm the project output directory and participants before persisting interview answers. Module, founder, checkpoint, and brandbook files are task outputs, not edits to the installed references. If file-writing tools are unavailable, return the module and checkpoint contents for the user to save and state that automatic resumption is unavailable. Do not connect external storage or change agent memory settings.
...
Read the linked reference when starting its module; use it as the output template rather than modifying the installed copy.

| File | Label | Frameworks used |
|------|-------|-----------------|
| [10_purpose-why.md](references/10_purpose-why.md) | Purpose / Why | Sinek Golden Circle, Lencioni |
| [20_positioning.md](references/20_positioning.md) | Positioning | Dunford "Obviously Awesome", Moore template |
| [30_audience-niche.md](references/30_audience-niche.md) | Audience & Niche | Baker "Business of Expertise", ICP |
| [40_personality-archetype.md](references/40_personality-archetype.md) | Personality & Archetype | Mark & Pearson 12 archetypes, J. Aaker 5 dims |
| [50_voice-tone.md](references/50_voice-tone.md) | Voice & Tone | Brand voice guidelines |
| [60_narrative-story.md](references/60_narrative-story.md) | Narrative / Story | Neumeier trueline, brand story arc |
| [70_founder-tension.md](references/70_founder-tension.md) | Founder Brands vs Studio Brand | Enns "Win Without Pitching" |
| [90_SYNTHESIS.md](references/90_SYNTHESIS.md) | Master Brandbook | Kapferer prism, Aaker brand system |
...
- Optional competitive analysis: after the positioning brief, scope and categorise direct competitors, adjacent alternatives, and the status quo using sourced evidence. The upstream `competitive-platform-analysis` companion is not required or installed.
- Optional `ecc-brand-voice` — if the voice-and-tone module needs a separate source-derived writing-style profile; otherwise use Module 50 to record sample-backed rhythm, tone, preferred words, and avoided moves.

## Attribution

Adapted from ECC by Affaan Mustafa, revision `e04ea0b9cc8248686edf5ac751cadff550e162b8`. MIT license; see `LICENSE` in this directory. All eight upstream module templates are retained. Local adaptations namespace references and clarify task-output persistence; no effectiveness or live-integration claim is made.
