...
description: "Use when writing pytest fixtures, mocks, parametrized tests, exception assertions, or reviewing Python test coverage."
license: MIT
metadata:
  origin: ECC
  source: https://github.com/affaan-m/ECC/blob/e04ea0b9cc8248686edf5ac751cadff550e162b8/skills/python-testing/SKILL.md
  revision: e04ea0b9cc8248686edf5ac751cadff550e162b8
  category: Python
  summary: "Adapted ECC reference for python testing; project contracts and caller authorization take precedence."
---
...
When implementing behavior with TDD, use the project-approved cycle:
...
- Preserve the consuming project's coverage contract. Prioritize observable critical-path behavior and boundary cases.
...
- **Respect project coverage requirements**: Focus on observable critical paths
