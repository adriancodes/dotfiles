...
description: Use when writing Rust ownership, borrowing, lifetimes, traits, async concurrency, typed errors, or unsafe boundaries.
license: MIT
metadata:
  origin: ECC
  source: https://github.com/affaan-m/ECC/blob/e04ea0b9cc8248686edf5ac751cadff550e162b8/skills/rust-patterns/SKILL.md
  revision: e04ea0b9cc8248686edf5ac751cadff550e162b8
  category: Rust
  summary: Rust rust patterns reference adapted from ECC for bounded local work.
---
...
# Dependency updates require a diagnosed need and explicit dependency-change scope.
